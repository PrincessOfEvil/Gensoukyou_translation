...
public class FM_PsiEffectScript extends BaseEveryFrameCombatPlugin {


    private CombatEngineAPI engine;
    private int skipFrame = 0;
    private ShipAPI playerShip_last = null;
    private Set<CombatFleetManagerAPI> managers = new HashSet<>();
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        if (player_bonus != 0f) {
            ...
            engine.maintainStatusForPlayerShip(INFO, Global.getSettings().getSpriteName("ui", "icon_tactical_electronic_warfare"),
                    I18nUtil.getString("misc","FM_PsiEffect_T"), I18nUtil.getString("misc","FM_PsiEffect_D") + (100 - player_bonus) + "%", false);
        }
