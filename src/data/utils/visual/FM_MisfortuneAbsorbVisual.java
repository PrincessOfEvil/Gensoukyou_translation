...
public class FM_MisfortuneAbsorbVisual extends BaseCombatLayeredRenderingPlugin {
    ...
    public static class FM_MAVParams implements Cloneable{
        ...
        public FM_MAVParams(float radius, float thickness, Color color, boolean additive) {
            super();
            this.radius = radius;
    ...
    public FM_MisfortuneAbsorbVisual(FM_MAVParams params){
        this.params = params;
    }
