...
public class FM_Gensokyo {
    ...
    public void generate(SectorAPI sector) {
        ...
        system.addAsteroidBelt(gensokyo_star, 100, 2000f, 150f, 180, 360, Terrain.ASTEROID_BELT, "");
...
//        nebula.setLocation(0,13000f);
        ...
        SectorEntityToken gate = system.addCustomEntity("FM_Gensokyo_gate", // unique id
                "Gensokyo 之门", // name - if null, defaultName from custom_entities.json will be used
...
//        crinoMarket.getIndustry(Industries.STARFORTRESS_HIGH).setAICoreId(Commodities.ALPHA_CORE);
        ...
        SectorEntityToken relay = system.addCustomEntity("gensokyo_relay", // unique id
                "境界中继站", // name - if null, defaultName from custom_entities.json will be used
        ...
        JumpPointAPI jumppoint = Global.getFactory().createJumpPoint("gensokyo_jump", "幻想之门");
