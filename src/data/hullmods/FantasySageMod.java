...
public class FantasySageMod extends BaseHullMod {
    ...
    public static final float VITAL_STRIKE = 100f;
    ...
    static {
        ...
        mag.put(ShipAPI.HullSize.FRIGATE, 7f);
        mag.put(ShipAPI.HullSize.DESTROYER, 14f);
        mag.put(ShipAPI.HullSize.CRUISER, 28f);
        mag.put(ShipAPI.HullSize.CAPITAL_SHIP, 42f);
    }

    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        stats.getDamageToTargetWeaponsMult().modifyMult(id, 1 + VITAL_STRIKE / 100);
        stats.getDamageToTargetEnginesMult().modifyMult(id, 1 + VITAL_STRIKE / 100);
    ...
    public boolean isApplicableToShip(ShipAPI ship) {
        return
                ship.getVariant().getHullMods().contains(FantasyBasicMod.FANTASYBASICMOD)
    ...
    public String getDescriptionParam(int index, ShipAPI.HullSize hullSize) {
        ...
        if (index == 4) return "" + ((int)VITAL_STRIKE + "%");
